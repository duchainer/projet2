...
public class PrincipaleFrame extends JFrame implements ActionListener {
	...
	public void addChampDeTexte(String label) {
		simplePanel.add(new  JLabel (label));                         //Ajoute étiquette au panneau 
	...
	private void creeVendeur() throws Exception {
		...
		JOptionPane.showMessageDialog(null, "Compte enregistré: " + dep1.getTabEmploye(dep1.getNbrEmploye()-1).codeAcces(),
	...
	private void affichage() {
		...
		try{
			...
			JOptionPane.showMessageDialog(null, "Code erroné ou inexistant","ERREUR",JOptionPane.ERROR_MESSAGE);
		}
		catch (Exception e1) {
